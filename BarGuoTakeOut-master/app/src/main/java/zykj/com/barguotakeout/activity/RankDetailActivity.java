 ...
 */
public class RankDetailActivity extends CommonActivity implements View.OnClickListener{
    ...
    public void onClick(View view){
        if(TextUtils.isEmpty(userid)){
            //还没有登录 弹出对话框立即登录
            ToastUTil.showToastText(RankDetailActivity.this, "提醒", "请先登录!", "确定");
            return;
        }else{
            ...
            HttpUtil.drawlottery(new HttpErrorHandler() {
                ...
                public void onRecevieSuccess(JSONObject json) {
                    ToastUTil.showToastText(RankDetailActivity.this, "抽奖详情", "你的抽奖号码为123456，抽奖结果将于5月31日公布，请注意查收。", "确定");
                }

                @Override
                public void onRecevieFailed(String status, JSONObject json) {
                    ToastUTil.showToastText(RankDetailActivity.this, "提醒", json.getString("msg"), "确定");
                }
